...
function init() {
    ...
    planeMaterial.roughnessMap = loader.load(concrete);
    planeMaterial.bumpMap = loader.load(concrete);
    ...
    sphereMaterial.roughnessMap = loader.load(fingerprints);
    sphereMaterial.envMap = reflectionCube;
  
    const maps = ['map', 'bumpMap', 'roughnessMap'];
    maps.forEach((map) => {
      const texture = planeMaterial[map];
